program sch
    ...
    open(unit=10, file='dens_prob.dat', status='unknown')                       ! j, dens_prob, parte real, parte imaginaria
    open(unit=11, file='normalizado.dat', status='unknown')                         ! n, integral
    ...
    do n=0, 500
        ...
        write(12,*) n, suma_x, real(suma_p), real(suma_h), pi*pi*ene*ene, inc_x*inc_p
        write(12,*)
